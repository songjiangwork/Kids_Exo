...
from kids_exo.online.french_alphabet import (
...
def create_practice_session(request: OnlineSessionRequest) -> PracticeSessionSnapshot:
    ...
    if request.plugin == "french_school_word_sounds":
        return create_french_school_words_session(request)
    if request.plugin == "french_fruit_word_sounds":
    ...
    if request.plugin == "french_school_word_spelling":
        settings = load_french_common_word_spelling_settings(request.plugin_settings)
        return create_french_school_word_spelling_session(request, settings)
    if request.plugin == "french_fruit_word_spelling":
        settings = load_french_common_word_spelling_settings(request.plugin_settings)
        return create_french_fruit_word_spelling_session(request, settings)
